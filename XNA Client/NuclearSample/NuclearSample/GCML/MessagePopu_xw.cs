...
namespace GCML.UI
{
    public class MessagePopup_XW: Popup<IMenuManager>
    {
        ...
        //----------------------------------------------------------------------
        public MessagePopup_XW( IMenuManager _manager )
        : base( _manager )
        {
...

            {
                ...
                // Confirm
                mConfirmButton = new Button( Screen, NuclearWinter.i18n.Common.Confirm );
        ...
        public void Setup(clsUnit aktUnit, Action<bool> _confirmCallback = null)
        {
            TitleLabel.Text = aktUnit.UnitType.strBez;

            
            MessageLabel.Text = "foobar";
            ContentGroup.Clear();
            ContentGroup.AddChild(MessageLabel);
            

            mConfirmButton.Text = "Move";
        ...
        public override void Close()
        {
            TitleLabel.Text = "";
            MessageLabel.Text = "";
            mConfirmButton.Text = NuclearWinter.i18n.Common.Confirm;
