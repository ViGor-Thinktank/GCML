...
{
    // HINWEIS: Mit dem Befehl "Umbenennen" im Menü "Umgestalten" können Sie den Schnittstellennamen "ICampaignMasterService" sowohl im Code als auch in der Konfigurationsdatei ändern.
    [ServiceContract]
